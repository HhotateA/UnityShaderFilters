Shader "HOTATE/Filter/Glare" {
    ...
    SubShader {
		...
		Pass {
            ...
            static float3 linecolumn[37]={
                float3( 3.0,-4.0, 1.0),                                                                                                                                                                         float3( 4.0, 4.0, 1.0),
                float3( 2.0,-4.0, 4.0), float3( 3.0,-3.0, 4.0),                                                                                                                         float3( 3.0, 3.0, 4.0), float3( 3.0, 4.0, 4.0),
                                        float3( 2.0,-3.0, 4.0), float3( 2.0,-2.0, 5.0), float3( 2.0,-1.0, 7.0),                         float3( 2.0, 1.0, 7.0), float3( 2.0, 2.0, 5.0), float3( 2.0, 3.0, 4.0), 
                                                                float3( 1.0,-2.0, 7.0), float3( 1.0,-1.0, 9.0), float3( 1.0, 0.0, 6.0), float3( 1.0, 1.0, 9.0), float3( 1.0, 2.0, 7.0), 
                                                                                        float3( 0.0,-1.0, 6.0), float3( 0.0, 0.0,10.0), float3( 0.0, 1.0, 6.0), 
                                                                float3(-1.0,-2.0, 7.0), float3(-1.0,-1.0, 9.0), float3(-1.0, 0.0, 6.0), float3(-1.0, 1.0, 9.0), float3(-1.0, 2.0, 7.0), 
                                        float3(-2.0,-3.0, 4.0), float3(-2.0,-2.0, 5.0), float3(-2.0,-1.0, 7.0),                         float3(-2.0, 1.0, 7.0), float3(-2.0, 2.0, 5.0), float3(-2.0, 3.0, 4.0), 
                float3(-2.0,-4.0, 4.0), float3(-3.0,-3.0, 4.0),                                                                                                                         float3(-3.0, 3.0, 4.0), float3(-3.0, 4.0, 4.0),
                float3(-3.0,-4.0, 1.0),                                                                                                                                                                         float3(-4.0, 4.0, 1.0),
